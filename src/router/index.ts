...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/admin/dashboard', name: 'admin-dashboard', component: AdminView, meta: { title: 'Dashboard', requiresAuth: true, role: 'admin' }, },
    { path: '/admin/restaurant', name: 'admin-restaurant', component: AdminView, meta: { title: 'Mi Restaurante', requiresAuth: true, role: 'admin' }, },
    { path: '/admin/reservations', name: 'admin-reservations', component: AdminView, meta: { title: 'Reservas', requiresAuth: true, role: 'admin' }, },
    { path: '/admin/reviews', name: 'admin-reviews', component: AdminView, meta: { title: 'Reseñas', requiresAuth: true, role: 'admin' }, },
  ],
});
